...
fun InformationScreen(
    ...
    val multas = MultasDefaultDataSource.itemCardInformation1

    /*
    val navBackStackEntry by navController.currentBackStackEntryAsState()
    val idCasaInfraccion = navBackStackEntry?.arguments?.getInt("id_casa_infraccion")

    val multas = if (idCasaInfraccion != null) {
        when (idCasaInfraccion) {
            1 -> MultasDefaultDataSource.itemCardInformation1
            2 -> MultasDefaultDataSource.itemCardInformation2
            3 -> MultasDefaultDataSource.itemCardInformation3
            4 -> MultasDefaultDataSource.itemCardInformation4
            else -> MultasDefaultDataSource.itemCardInformation5
        }
    } else {
        // Manejar el caso cuando idCasaInfraccion es nulo
        emptyList()
    }
        ...
        LazyRow(
            ...
            items(botones.size) {
                Button(
                    ...
                    Text(text = botones[it], color = TextWhite, fontWeight = FontWeight.Bold, fontSize = 20.sp)
                }
            }
        }
    }
